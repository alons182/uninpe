    ...
    <?php endif;?>
		...
		<table class="table table-stripped">
             <thead>
			   ...
			   <th><?php echo JHTML::_('grid.sort',   JText::_('COM_JOOMDLE_PROFILE_TYPE'), 'name', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
			   <th><?php echo JHTML::_('grid.sort',   JText::_('COM_JOOMDLE_CREATE_ON_MOODLE'), 'create_on_moodle', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
                    </tr>              
             </thead>
		<tfoot>
                        <tr>
